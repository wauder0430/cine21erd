-- 시놉시스 DML
insert into SYNOPSIS VALUES (SYNOPSIS_SEQ.NEXTVAL, '가장 초라했던 그때,
가장 눈부시던 우리
...
INSERT INTO SYNOPSIS VALUES (SYNOPSIS_SEQ.NEXTVAL, '대북제재로 돈줄이 막힌 북한.
국제사회의 2억 달러 지원을 얻기 위한 마지막 방법은 단 하나!
보위부는 당의 명령을 받고, 북한 최초의 가짜 찬양단을 만드는 임무를 맡는다.');
INSERT INTO SYNOPSIS VALUES (SYNOPSIS_SEQ.NEXTVAL, '월드 와이드 흥행 불멸의 1위 <아바타> 시리즈의 세 번째 이야기!
...
INSERT INTO SYNOPSIS VALUES (SYNOPSIS_SEQ.NEXTVAL, '화려한 도시 한가운데에서 다른 내일을 꿈꾸며 살아가던 미선과 도경.
하지만 그 희망마저 빼앗기고 벼랑 끝까지 내몰린 상황,
두 사람은 우연히 알게 된 검은 돈과 숨겨진 금괴를 훔쳐 새로운 기회를 만들고
돈과 금괴에 얽힌 이들이 미선과 도경을 뒤쫓기 시작하는데…');
INSERT INTO SYNOPSIS VALUES (SYNOPSIS_SEQ.NEXTVAL, '일곱 개의 빛이 하나로 모일 때,
비로소 어둠의 군주가 다시 깨어난다!
...
INSERT INTO SYNOPSIS VALUES (SYNOPSIS_SEQ.NEXTVAL, '더 화려해진 세계, 더 넓어진 주토피아!
...
INSERT INTO SYNOPSIS VALUES (SYNOPSIS_SEQ.NEXTVAL, '돌아온 남자 승민(권상우)이 다시 만난 첫사랑을 놓치지 않기 위해 고군분투하지만,
그녀에게 절대 말할 수 없는 비밀이 생기며 벌어지는 코미디');
INSERT INTO SYNOPSIS VALUES (SYNOPSIS_SEQ.NEXTVAL, '전설의 공중도시 ‘라퓨타’를 향한
거대한 여정이 시작된다!
...
INSERT INTO SYNOPSIS VALUES (SYNOPSIS_SEQ.NEXTVAL, '광활한 사막 한가운데에서 펼쳐지는 레이브 파티
...
이 영화를 감당할 수 있는가
');
INSERT INTO SYNOPSIS VALUES (SYNOPSIS_SEQ.NEXTVAL, '“아직도 여기가 회사인 줄 아나 봐?”
...
INSERT INTO SYNOPSIS VALUES (SYNOPSIS_SEQ.NEXTVAL, '사랑은 그렇게 다시 기억된다.
...
당신을 지우면 이 아픔도 사라질까요?
사랑은 그렇게 다시 기억된다.');
INSERT INTO SYNOPSIS VALUES (SYNOPSIS_SEQ.NEXTVAL, '나는 오늘, 언니를 납치했다!
...
INSERT INTO SYNOPSIS VALUES (SYNOPSIS_SEQ.NEXTVAL, '전 세계 350만 부 이상 판매된 고자극 반전 스릴러!
...
INSERT INTO SYNOPSIS VALUES (SYNOPSIS_SEQ.NEXTVAL, '“나는 이제 어디로 갑니까…”
...
<왕과 사는 남자>');
INSERT INTO SYNOPSIS VALUES (SYNOPSIS_SEQ.NEXTVAL, '중국 북동부에서 일본 제국군 731부대가 자행한 세균 실험을 배경으로,
평범한 개인이 겪는 격동의 운명을 통해 감춰진 범죄의 실체를 폭로하는 잔혹 역사 영화');
INSERT INTO SYNOPSIS VALUES (SYNOPSIS_SEQ.NEXTVAL, '인간과 99% 동일한 DNA
성인 남성 2배의 괴력…
...
INSERT INTO SYNOPSIS VALUES (SYNOPSIS_SEQ.NEXTVAL, '위기에 처한 곤충들을 구하기 위해
고고다이노 대원들이 작아졌어요!
...
INSERT INTO SYNOPSIS VALUES (SYNOPSIS_SEQ.NEXTVAL, '매일 너의 기억을 채워주고 싶은 남자, 김재원(추영우)
...
내일의 너를 다시 사랑할 거야');
INSERT INTO SYNOPSIS VALUES (SYNOPSIS_SEQ.NEXTVAL, '“카미야 토루에 대해 잊지 말 것”
...
INSERT INTO SYNOPSIS VALUES (SYNOPSIS_SEQ.NEXTVAL, '1형 당뇨 판정을 받은 어린 아들 ‘동명’을 위해 고군분투하다
세상을 바꾸어 버린 엄마의 이야기');
